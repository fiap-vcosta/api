...
| Métricas OS | DogStatsD (`techchallenge.ordem_servico.status`) nos handlers que mudam status |
...
- Collections HTTP: [`docs/07_api.md`](docs/07_api.md) (Swagger + Requestly; e2e Gateway em `12-gateway-cliente-aprovar`)
