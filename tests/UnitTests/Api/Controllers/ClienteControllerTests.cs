...
public class ClienteControllerTests
{
    ...
    public async Task GetAll_ReturnsOkWithListOfClientes()
    {
        ...
        {
            new ClienteResponse { Id = 1, Nome = "Cliente 1", TipoDocumento = 0, Documento = "11144477735" },
            new ClienteResponse { Id = 2, Nome = "Cliente 2", TipoDocumento = 1, Documento = "12345678901234" }
        };
