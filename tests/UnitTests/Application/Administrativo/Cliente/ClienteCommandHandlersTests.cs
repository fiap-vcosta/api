...
public class CreateClienteCommandHandlerTests
{
    ...
    public async Task Handle_CreatesCliente_WhenCommandIsValid()
    {
        ...
        _mockRepository.Setup(r => r.CreateAsync(It.IsAny<ClienteAggregateRoot>()))
        ...
        _mockRepository.Verify(r => r.CreateAsync(It.IsAny<ClienteAggregateRoot>()), Times.Once);
    }
}
...
public class UpdateClienteCommandHandlerTests
{
    ...
    public async Task Handle_UpdatesCliente_WhenClienteExists()
    {
        ...
        _mockRepository.Setup(r => r.UpdateAsync(It.IsAny<ClienteAggregateRoot>()))
            .Returns(Task.CompletedTask);
        ...
        _mockRepository.Verify(r => r.UpdateAsync(It.IsAny<ClienteAggregateRoot>()), Times.Once);
    }
