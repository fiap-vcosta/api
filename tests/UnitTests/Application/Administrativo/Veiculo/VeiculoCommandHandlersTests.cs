...
public class CreateVeiculoCommandHandlerTests
{
    ...
    public async Task Handle_CreatesVeiculo_WhenCommandIsValid()
    {
        ...
        _mockClienteRepository.Setup(r => r.GetByIdAsync(1))
            .ReturnsAsync(new Domain.Administrativo.Entities.Cliente { Id = 1, Nome = "Cliente Teste", TipoDocumento = TipoDocumento.Cpf, Documento = "11144477735" });

        _mockVeiculoRepository.Setup(r => r.GetByPlacaAsync(command.Placa))
            .ReturnsAsync((Domain.Administrativo.Entities.Veiculo?)null);

        _mockVeiculoRepository.Setup(r => r.CreateAsync(It.IsAny<Domain.Administrativo.Entities.Veiculo>()))
            .Callback<Domain.Administrativo.Entities.Veiculo>(v => v.Id = 1)
        ...
        _mockVeiculoRepository.Verify(r => r.CreateAsync(It.IsAny<Domain.Administrativo.Entities.Veiculo>()), Times.Once);
    }
    ...
    public async Task Handle_ThrowsKeyNotFoundException_WhenDonoDoesNotExist()
    {
        ...
        _mockClienteRepository.Setup(r => r.GetByIdAsync(999)).ReturnsAsync((Domain.Administrativo.Entities.Cliente?)null);
    ...
    public async Task Handle_ThrowsInvalidOperationException_WhenPlacaAlreadyExists()
    {
        ...
        _mockClienteRepository.Setup(r => r.GetByIdAsync(1))
            .ReturnsAsync(new Domain.Administrativo.Entities.Cliente { Id = 1, Nome = "Cliente Teste", TipoDocumento = TipoDocumento.Cpf, Documento = "11144477735" });
        _mockVeiculoRepository.Setup(r => r.GetByPlacaAsync(command.Placa))
            .ReturnsAsync(new Domain.Administrativo.Entities.Veiculo { Id = 2, Placa = command.Placa, DonoId = 1, Modelo = "Uno", Marca = "Fiat" });
...
public class UpdateVeiculoCommandHandlerTests
{
    ...
    public async Task Handle_UpdatesVeiculo_WhenVeiculoExists()
    {
        ...
        _mockVeiculoRepository.Setup(r => r.GetByIdAsync(1))
            .ReturnsAsync(new Domain.Administrativo.Entities.Veiculo { Id = 1, Placa = "ABC-1D23", DonoId = 1, Modelo = "Gol", Marca = "Volkswagen" });
        ...
        _mockVeiculoRepository.Setup(r => r.UpdateAsync(It.IsAny<Domain.Administrativo.Entities.Veiculo>()))
            .Returns(Task.CompletedTask);
        ...
        _mockVeiculoRepository.Verify(r => r.UpdateAsync(It.IsAny<Domain.Administrativo.Entities.Veiculo>()), Times.Once);
    }
    ...
    public async Task Handle_ThrowsKeyNotFoundException_WhenVeiculoDoesNotExist()
    {
        ...
        _mockVeiculoRepository.Setup(r => r.GetByIdAsync(999)).ReturnsAsync((Domain.Administrativo.Entities.Veiculo?)null);
