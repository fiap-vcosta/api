...
public class CreateItemEstoqueCommandHandlerTests
{
    ...
    public async Task Handle_CreatesItemEstoque_WhenCommandIsValid()
    {
        ...
        _mockRepository.Setup(r => r.CreateAsync(It.IsAny<ItemEstoqueAggregateRoot>()))
        ...
        _mockRepository.Verify(r => r.CreateAsync(It.IsAny<ItemEstoqueAggregateRoot>()), Times.Once);
    }
...
public class UpdateItemEstoqueCommandHandlerTests
{
    ...
    public async Task Handle_UpdatesItemEstoque_WhenItemExists()
    {
        ...
        _mockRepository.Setup(r => r.GetByCodigoAsync(command.Codigo))
            .ReturnsAsync((ItemEstoqueAggregateRoot?)null);
        _mockRepository.Setup(r => r.UpdateAsync(It.IsAny<ItemEstoqueAggregateRoot>()))
            .Returns(Task.CompletedTask);
        ...
        _mockRepository.Verify(r => r.UpdateAsync(It.IsAny<ItemEstoqueAggregateRoot>()), Times.Once);
    }
    ...
    public async Task Handle_ThrowsKeyNotFoundException_WhenItemDoesNotExist()
    {
        ...
        _mockRepository.Setup(r => r.GetByIdAsync(999)).ReturnsAsync((ItemEstoqueAggregateRoot?)null);
