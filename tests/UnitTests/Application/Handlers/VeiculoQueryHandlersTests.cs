...
using Application.Veiculo.Queries.Handlers;
...
public class VeiculoQueryHandlersTests
{
    ...
    {
        var veiculo = new Veiculo { Id = 1, Placa = "ABC-1D23", DonoId = 1, Modelo = "Gol", Marca = "Volkswagen" };
    ...
    {
        _mockRepository.Setup(r => r.GetByIdAsync(999)).ReturnsAsync((Veiculo?)null);
